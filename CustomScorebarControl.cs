...
{
    public class CustomScorebarControl : Control
    {
        private int ID;
        ...
        public CustomScorebarControl(Bitmap Logo, int ID, PictureBox picBox, Size BackgroundSize, List<Inmage> ImgList, ImgsHandler layerBuilder)
        {
